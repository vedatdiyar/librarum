...
>(({ className, ...props }, ref) => (
  <div className="w-full overflow-x-auto rounded-[24px] border border-border/20 bg-surface/30 px-1">
...
>(({ className, ...props }, ref) => (
  <th
    className={cn(
      "h-12 px-4 text-left align-middle text-[11px] font-medium uppercase tracking-[0.18em] text-text-secondary",
      className
    )}
    ref={ref}
    {...props}
