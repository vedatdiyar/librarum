...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Overlay
    ref={ref}
    className={cn("fixed inset-0 z-50 bg-black/60 backdrop-blur-[6px]", className)}
    {...props}
  />
));
...
const DialogFooter = ({
  ...
  <div
    className={cn(
      "flex flex-col-reverse gap-3 border-t border-border/60 bg-surface px-6 py-4 sm:flex-row sm:justify-end",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <DialogPrimitive.Title
    ref={ref}
    className={cn("font-sans text-2xl font-semibold tracking-[-0.03em] text-text-primary", className)}
    {...props}
  />
));
