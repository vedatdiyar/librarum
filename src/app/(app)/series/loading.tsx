  ...
  return (
    <section className="space-y-10 pb-20">
      ...
      <div className="glass-panel overflow-hidden rounded-3xl border border-white/5 bg-white/1">
          <div className="flex flex-col items-start justify-between gap-6 border-b border-white/3 px-8 py-6 md:flex-row md:items-center">
              <div>
          ...
          <div className="space-y-4 px-4 py-8">
            {Array.from({ length: 8 }).map((_, i) => (
              <div className="flex h-16 items-center gap-4 rounded-xl border border-white/2 bg-white/2 px-4 shadow-sm" key={`series-skeleton-row-${i}`}>
