...
function FilterSelect({
  ...
  return (
    <select
      ...
      className="h-11 w-full rounded-2xl border border-border/60 bg-surface-raised/65 px-3 text-sm text-text-primary outline-none transition duration-200 focus:border-accent/55 focus:bg-surface-raised/85 focus:ring-2 focus:ring-accent/12"
...
export function BooksFilterBar({
  ...
  return (
    <Card className="bg-surface/90 p-5 md:p-6" surface="raised">
      <div className="mb-4 flex flex-col gap-1">
        <p className="page-kicker">Filtreler</p>
        <p className="text-sm text-text-secondary">
          Kütüphane görünümünü durum, kategori, yazar, seri ve raf konumuna göre daralt.
        </p>
      </div>
