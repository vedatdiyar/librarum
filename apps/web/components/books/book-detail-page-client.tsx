    ...
    <>
      <div className="grid gap-12 lg:grid-cols-[380px,1fr]">
        <aside className="space-y-8">
          <div className="group relative aspect-[2/3] w-full overflow-hidden rounded-[40px] border-[1.5px] border-border/80 bg-surface-raised shadow-2xl transition-all hover:border-accent/40 hover:shadow-accent/5">
            {book.coverUrl ? (
              <Image
                alt={book.title}
